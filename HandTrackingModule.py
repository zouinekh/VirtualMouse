...
class HandDetector :
    def __init__(self ,mode=False , maxHand=2 , detectCon=0.5 ,trackCon=0.5):
        ...
        self.tipIds = [4, 8, 12, 16, 20]#les numero de doight (tip of fingers)
...
#houni if there is a finger up tableau lmlist yet7at fih 1 si nn 0
        return fingers
    ...
    def findDistance(self, p1, p2, img, draw=True, r=15, t=3):
        ...
        if draw:
            cv.line(img, (x1, y1), (x2, y2), (0, 32, 155), t)
